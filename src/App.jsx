...
const ENVIRONMENTS = [
  ...
  { id: "office", label: "オフィス", icon: "🏢", cost: "0円", hours: "10時~22時", access: "徒歩20分",
    ...
    notes: "推定努力密度：100%",
    担当: "仕事" },
  { id: "starbucks", label: "作業可能飲食店", icon: "☕", cost: "2時間500~1000円(注文による)", hours: "スタバ推奨7時~21時/マック推奨21時~7時", access: "徒歩20分/家庭教師ついで",
    permitted: ["勉強", "仕事", "ゲーム"],
    gray: ["仕事", "ゲーム"],
    notes: "ゲームは少量のもののみ。\n推定努力密度：75%\n月間利用料目安：4000円(6回)",
    担当: "勉強(短時間)、ゲーム(少量)" },
...
const BASIC_RULES_SUBS = [
  ...
  { key: "schedule", title: "外出・就寝時間", rules: [
    ...
    R("大学やその他の予定がある日は、朝食30m(外出後の場合)+移動+快活クラブ(モード3)で計2hは使うことを想定し、さらにそこから移動する時間も考えて、十分早く外出する。特に、大学までの移動は最低30mとする。"),
