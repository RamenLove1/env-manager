...
function RulesTab({ dyn, setDyn }) {
  ...
  const addPeriod = () => { const n = { ...dyn, periodRules: [...dyn.periodRules, { id: Date.now(), label: "新しい期間", startDate: "", endDate: "", guidelines: { "勉強": "5h", "仕事": "3h", "運動": "30m", "家事": "30m", "趣味": "2h", "リラックス": "1h" }, choices: [], rules: [], effects: [] }] }; setDyn(n); saveDyn(n); };
