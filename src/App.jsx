...
function loadDyn() {
  try { const r = localStorage.getItem("env-mgr-dyn-v7"); return r ? JSON.parse(r) : null; } catch { return null; }
}
function saveDyn(d) {
  try { localStorage.setItem("env-mgr-dyn-v7", JSON.stringify(d)); } catch {}
}
