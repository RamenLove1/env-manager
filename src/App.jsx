...
const BASIC_RULES_SUBS = [
  ...
  { key: "general", title: "一般", rules: [
    ...
    R("寝るまでにやることを考え、時間付きでメモしてからでないと家に帰ってはいけない。また、その内容は守らなくてはならない。"),
...
const VIOLATION_RULES = [
  ...
  R("スマホでYoutube違反をしてしまった場合は、当日~2日後は家、快活クラブへの持ち込みは禁止で、その環境へ移動する前に必ずコインロッカーに預ける。"),
