...
const ENVIRONMENTS = [
  ...
  { id: "kaikatsu3", label: "快活クラブ(モード3)", icon: "📚", cost: "平日: 1h600円/3h1200円/6h1700円/9h2200円/12h2600円/24h4500円/ナイト12h2200円\n休日: 1h600円/3h1400円/6h2000円/9h2500円/12h2900円/24h4800円", hours: "いつでも", access: "徒歩20分",
    ...
    gray: ["ゲーム"],
    notes: "1日1時間まで。漫画1巻または50分以内のYoutube動画1本。\n月間利用料目安：10000円",
    担当: "外出誘発漫画" },
...
const BASIC_RULES = [
  ...
  R("大学やその他の予定がある日の前日は、準備+朝食+移動+外出誘発行動で計4h30mは使うことを想定し、さらにそこから移動する時間も考えて、6h30mは寝られるよう、前日の睡眠時刻を合わせる。特に、大学までの移動は最低30mとする。"),
  R("大学やその他の予定がある日は、準備+朝食+移動+外出誘発行動で計4h30mは使うことを想定し、さらにそこから移動する時間も考えて、十分早く外出する。特に、大学までの移動は最低30mとする。"),
  R("大学やその他の予定が朝早くからある場合に短時間で外出を誘発するために快活クラブ(モード3)を用意してあるので、その用途のみに使う。その際、準備+朝食+移動+快活クラブ(モード3)で計2h30mは使うことを想定し、さらにそこから移動する時間も考えて、6h30mは寝られるよう、前日の睡眠時刻を合わせる。特に、大学までの移動は最低30mとする。"),
  R("大学やその他の予定が朝早くからあり、快活クラブ(モード3)が許可されている場合は、準備+朝食+移動+快活クラブ(モード3)で計2h30mは使うことを想定し、さらにそこから移動する時間も考えて、十分早く外出する。特に、大学までの移動は最低30mとする。"),
