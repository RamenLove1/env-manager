...
const BASIC_RULES = [
  ...
  R("制御規定の追加規定では、「テストで100点とる」など、成功を条件にしてはいけない。「勉強を10時間やる」など、やることそのものを条件にする。"),
...
const PHILOSOPHY = [
  ...
  R("大学やその他の予定がある日の前日は、準備+移動+外出誘発行動で計4hは使うことを想定し、前日の睡眠時刻を合わせる。"),
  R("大学やその他の予定が朝早くからある場合に短時間で外出を誘発するために快活クラブ(モード3)を用意してあるので、その用途のみに使う。その際、準備+移動+快活クラブ(モード3)で計2hは使うことを想定し、前日の睡眠時刻を合わせる。"),
