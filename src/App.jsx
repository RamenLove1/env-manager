...
const BASIC_RULES_SUBS = [
  ...
  { key: "schedule", title: "外出・就寝時間", rules: [
    ...
    R("大学やその他の予定が朝9時30分までにある場合、快活クラブ(モード3)を許可する。その際、準備+朝食+移動+快活クラブ(モード3)で計2h30mは使うことを想定し、さらにそこから移動する時間も考えて、6h30mは寝られるよう、前日の睡眠時刻を合わせる。特に、大学までの移動は最低30mとする。"),
    R("快活クラブ(モード3)が許可されている場合は、朝食30m(外出後の場合)+移動+快活クラブ(モード3)で計2hは使うことを想定し、さらにそこから移動する時間も考えて、十分早く外出する。特に、大学までの移動は最低30mとする。"),
    R("想定外の事態で上記の外出が間に合わない場合、できる限り早く外出し、朝食も抜く。それ以上の対応はしない。"),
  ]},
