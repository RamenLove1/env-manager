...
const BASIC_RULES = [
  ...
  R("大学やその他の予定がある日の前日は、準備+移動+外出誘発行動で計4h30mは使うことを想定し、6h30mは寝られるよう、前日の睡眠時刻を合わせる。"),
  R("大学やその他の予定が朝早くからある場合に短時間で外出を誘発するために快活クラブ(モード3)を用意してあるので、その用途のみに使う。その際、準備+移動+快活クラブ(モード3)で計2h30mは使うことを想定し、6h30mは寝られるよう、前日の睡眠時刻を合わせる。"),
